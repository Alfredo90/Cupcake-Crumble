  ...
  return (
    <li className="flex flex-col  m-20 w-400 h-420 rounded-xl border-2 shadow-xl">
      <div className="flex justify-center items-center m-10 ">
        <img src={img} alt={title} className="rounded-full w-192 h-192 border-2 border-gray-200 " />
      </div>
        <div className=" flex justify-between items-center mx-2.5 text-18 ">
          <h2 className=" font-medium text-xl italic font-lily text-amber-600">{title}</h2>
